...
let v0 = Vector2(0.1, 0.8);
let v1 = Vector2(0.5, 0.2);
let v2 = Vector2(0.9, 0.8);

// Measure rasterization time
let start_time = $time_current_ms();

// Rasterize triangle
rasterize_triangle(framebuffer, width, height, v0, v1, v2);

// Display elapsed time
let end_time = $time_current_ms() - start_time;
